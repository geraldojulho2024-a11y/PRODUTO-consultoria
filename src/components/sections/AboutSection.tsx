...
const AboutSection = () => {
  return <section id="sobre" className="py-16 lg:py-20 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        ...
        {/* First Blue Box + Visão Integrada - Aligned horizontally */}
        <div className="grid lg:grid-cols-2 gap-8 mb-8 items-start">
          {/* Ciclo de Desenvolvimento */}
          <div className="p-6 bg-gradient-primary rounded-2xl h-full">
          ...
          {/* Visão Integrada Card */}
          <div className="relative">
            <div className="relative bg-card rounded-3xl p-8 shadow-card-hover border border-border overflow-hidden h-full">
              ...
              <div className="relative space-y-6">
                <div className="text-center mb-6">
                  ...
                  <h3 className="font-display font-bold text-3xl lg:text-4xl text-foreground mb-2">
                    Visão Integrada
                  </h3>
                ...
                <div className="space-y-3">
                  {["Transformação de termoplástico", "Injeção de LSR", "Gestão de ferramentaria", "Otimização de processos"].map((item, index) => <div key={item} className="flex items-center gap-3 p-3 rounded-xl bg-muted/50 hover:bg-muted transition-colors">
                      <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center">
                        <span className="text-lg font-bold text-primary">{index + 1}</span>
                      </div>
                      <span className="text-base lg:text-lg font-semibold text-foreground">{item}</span>
                    </div>)}
                </div>
              </div>
            </div>
